...
abstract class AppLocalizations {
  ...
  /// No description provided for @shoppingBuddy.
  ///
  /// In en, this message translates to:
  /// **'Your Everyday Shopping Buddy'**
  String get shoppingBuddy;
  ...
  /// No description provided for @signInToCarty.
  ///
  /// In en, this message translates to:
  /// **'Sign In to Carty'**
  String get signInToCarty;
  ...
  /// No description provided for @emailAtError.
  ///
  /// In en, this message translates to:
  /// **'Email should contain @'**
  String get emailAtError;

  /// No description provided for @emailDotError.
  ///
  /// In en, this message translates to:
  /// **'Email should contain a domain (e.g. .com)'**
  String get emailDotError;

  /// No description provided for @emailStartEndError.
  ///
  /// In en, this message translates to:
  /// **'Email can\'t start or end with @ or .'**
  String get emailStartEndError;
  ...
  /// No description provided for @joinCarty.
  ///
  /// In en, this message translates to:
  /// **'Join Carty today!'**
  String get joinCarty;
